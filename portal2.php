      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
           ...
           <?php if($_SESSION['tipo_usuario']==1){ // Usuario super adminstrador   ?>
           
           <li><a href="#dashvariants" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Gestión de usuarios</a>
              <ul id="dashvariants" class="collapse list-unstyled">
                <li><a href="javascript:;">Usuarios</a></li>  
                <li><a href="javascript:;">Compilaciones</a></li>
              </ul>
            </li>


            	 <li><a href="#dashvariants3" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Gestión de Procesos</a>
              <ul id="dashvariants3" class="collapse list-unstyled">
                <li><a href="javascript:;" id="ctl_calidad">Control de calidad</a></li>
                <li><a href="javascript:;" id="entr_diag">Entregar Diagnósticos</a></li>  
                <li><a href="javascript:;" id="solicit">Solicitudes</a></li>
                <li><a href="javascript:;" id="pendi">Pendientes</a></li>
               
              </ul>
            </li>
            
            <li><a href="#dashvariants5" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Call Center</a>
              <ul id="dashvariants5" class="collapse list-unstyled">
                <li><a href="javascript:;" id="llamad_grabadas">Llamadas (Grabadas)</a></li>
         ...
         <?php }  ?>
           <?php if($_SESSION['tipo_usuario']==1 or $_SESSION['id_grupo']==3 or $_SESSION['id_grupo']==4 or $_SESSION['id_grupo']==5){ // Usuario super adminstrador   ?>
          <li><a href="#dashvariants4" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Gestión de documentos</a>
              <ul id="dashvariants4" class="collapse list-unstyled">
                <li><a href="javascript:;" id="cr_diagnostico">Elaborar diagnóstico(s)</a></li>  
                 <!--    <li><a href="javascript:;" id="borda">Borda</a></li>  
                <li><a href="javascript:;" id="segui_diagnostico">Seguimiento</a></li> --!> 
              </ul>
            </li>
             <?php }  ?> 
            <li><a href="#dashvariants2" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Encuestas</a>
              <ul id="dashvariants2" class="collapse list-unstyled">
                <li><a href="javascript:;" id="btndiagnostico">Diagnósticos</a></li>
                <li><a href="javascript:;" id="btnreporvisita">Reporte de Visitas</a></li>
              <!--   <li><a href="javascript:;">Prospectos</a></li>  --!> 
              
              <!--   <li><a href="#">Reporte de Visitas</a></li>
                <li><a href="#">Reporte de Promotores</a></li>    -!>
                <li><a href="javascript:;" id="btnpruebas">Pruebas</a></li>             
              </ul>
            </li>
